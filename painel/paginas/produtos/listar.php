...
<a class="btn btn-info btn-sm" href="#" onclick="editar('{$id}','{$codigo}','{$nome}','{$categoria}','{$sub_categoria}','{$valor_compraF}','{$valor_vendaF}','{$estoque}','{$nivel_estoque}','{$foto}','{$descricao}','{$valor_lucro}','{$lucro_reaisF}','{$valor_promoF}','{$tem_estoque}','{$mostrar_site}', '{$descricaoF}')" title="Editar Dados"><i class="fa fa-edit"></i></a>
	...
	<a class="btn btn-warning btn-sm" href="#" onclick="mostrar('{$codigo}','{$nome}','{$nome_categoria}','{$nome_sub_categoria}','{$valor_compraF}','{$valor_vendaF}','{$estoque}','{$ativo}','{$foto}','{$descricaoF}','{$valor_lucro}','{$lucro_reais}','{$valor_promoF}','{$tem_estoque}')" title="Mostrar Dados"><i class="fa fa-info-circle"></i></a>
