...
for ($i = 0; $i < $total_clientes; $i++) {
	...
	$pdo->query("INSERT INTO disparos set campanha = '$id', cliente = '$id_cliente', nome = '$nome_cliente', telefone = '$telefone_cliente', hora = '$hora', data_disparo = '$data_disparo', empresa = '$id_empresa'");
