...
<div class="modal fade" id="modalForm" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document" style="width:90%; overflow: scroll; height:auto; max-height: 90%; scrollbar-width: thin;">
			...
			<div class="modal-body">
					...
					<div class="row" style="margin-top: 10px">
						...
						<div class="col-md-2 col-6">		
							<div class="form-group"> 
								...
								<input class="form-control" type="number" name="mao_obra" id="mao_obra"  placeholder="Mão de Obra" onkeyup="totalizar()" onchange="totalizar()">
							</div>	
						</div>	
						...
						<div class="col-md-2 col-6">						
							<div class="form-group"> 
								...
								<input class="form-control" type="text" name="senha_ap" id="senha_ap" placeholder="Senha se Houver" >
							</div>						
						</div>	
					...
					<div class="row">
						...
						<div class="col-md-12">						
							<div class="form-group"> 
								<label>Defeito</label> 
								<input class="form-control" type="text" name="defeito" id="defeito" placeholder="Defeito">
							</div>						
						</div>
					...
					<div class="row">
						<div class="col-md-12">						
							<div class="form-group"> 
								...
								<input maxlength="1000" class="form-control" type="text" name="condicoes" id="condicoes" placeholder="Tela quebrada, arranhado">
							</div>						
						</div>			
					</div>
					...
					<div class="row">
						<div class="col-md-12">						
							<div class="form-group"> 
								...
								<input maxlength="1000" class="form-control" type="text" name="acessorios" id="acessorios" placeholder="Capa, Carregador, etc...">
							</div>								
						</div>													
					</div>
					...
					<div class="row">
						<div class="col-md-12">						
							<div class="form-group"> 
								...
								<input maxlength="1000" class="form-control" type="text" name="laudo" id="laudo" placeholder="Laudo Técnico">
							</div>						
						</div>								
					</div>
									...
									<table id="" class="text-left table table-bordered">
										...
										<tr>
											...
											<td><span id="nome_modelo_dados"></span></td>
																				...
																				<tr>
										<td width="35%" class="bg-primary text-white w_150">Senha</td>
							...
							<div class="tile">
								<div class="table-responsive">
									<table id="" class="text-left table table-bordered">
										...
										<tr>
											<td width="35%" class="bg-primary text-white w_150">Mão de Obra</td>
							...
							<div class="tile">
								<div class="table-responsive">
									<table id="" class="text-left table table-bordered">
										...
										<tr>
											<td width="15%" class="bg-primary text-white w_150">Defeito</td>
											<td><span id="defeito_dados"></span></td>
										</tr>

										<tr>
											<td width="15%" class="bg-primary text-white w_150">Laudo</td>
											<td><span id="laudo_dados"></span></td>
										</tr>

										<tr>
											<td width="15%" class="bg-primary text-white w_150">Condições</td>
											<td><span id="condicoes_dados"></span></td>
										</tr>

										<tr>
											<td width="15%" class="bg-primary text-white w_150">Acessóriso</td>
