...
$pdo->query("INSERT INTO itens_venda SET produto = '$id_produto', valor = '$valor', quantidade = '$quantidade', total = '$total', id_venda = '0', funcionario = '$id_usuario', empresa = '$id_empresa'");
