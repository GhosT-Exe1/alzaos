...
$modo_teste_emissao = true; // Defina como true para testar sem a API
...
if ($httpCode >= 200 && $httpCode < 300) {
    ...
    $query = $pdo->prepare("INSERT INTO notas_fiscais (empresa_id, cliente_id, numero, data_emissao, valor_total, status, id_nuvem_fiscal) VALUES (:empresa_id, :cliente_id, :numero, :data_emissao, :valor_total, :status, :id_nuvem_fiscal)");
    $query->bindValue(":empresa_id", $id_empresa);
    
    // Usa os dados da resposta (simulada ou real)
