...
<div class="breadcrumb-header justify-content-between">
	<div class="left-content mt-2">
		...
		<a style="" href="" data-bs-target="#modalImportar" data-bs-toggle="modal" type="button"
			class="btn btn-primary " target="_blank"><span class="fa fa-arrow-up"></span> Importar</a>

		<a  href="rel/excel_clientes.php" type="button"
			class="btn btn-success " target="_blank"><span class="fa fa-arrow-down"></span> Exportar</a>
