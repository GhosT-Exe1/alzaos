...
<a class="btn btn-warning-light btn-sm" href="#" onclick="mostrar('{$descricao}', '{$multaF}','{$jurosF}','{$nome_usuario}','{$frequencia}','{$obs}')" title="Mostrar Dados"><i class="fa-regular fa-eye"></i></a>
...
<script type="text/javascript">
	...
	function mostrar(descricao, multa, juros, usuario, frequencia, obs) {
