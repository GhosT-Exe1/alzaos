...
<table class="printer-ticket">
		...
		<td>
		<img style="margin-top: 10px; margin-left: 40px;" id="imag" src="<?php echo $url_sistema ?>img/<?php echo $logo_rel ?>" width="220px">
	</td>
 ...
 ?>
	...
	<tfoot>
		...
		<?php } ?>
			...
			<td align="right">R$ <?php echo $total_vendaF ?></td>
		<?php }else{ ?>
