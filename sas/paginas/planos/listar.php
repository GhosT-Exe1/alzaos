...
<td>
	<big><a class="btn btn-info-light btn-sm" href="#" onclick="editar('{$id}','{$nome}','{$valorF}','{$clientes}','{$usuarios}')" title="Editar Dados"><i class="fa fa-edit "></i></a></big>
...
<script type="text/javascript">
	function editar(id, nome, valor, clientes, usuarios) {
		$('#mensagem').text('');
