...
<div class="breadcrumb-header justify-content-between">
	<div class="left-content mt-2">
		...
		<a style="position:absolute; right:40px;" href="rel/excel_clientes.php" type="button"
			class="btn btn-success ocultar_mobile_app" target="_blank"><span class="fa fa-arrow-down"></span> Exportar</a>
				...
				<div class="modal-body ">
					...
					<div class="row">
						...
						<div class="col-md-2 mb-3 col-6">
							<label>Plano</label>
							<select class="form-select" name="plano" id="plano" onchange="alterarPlano()">
