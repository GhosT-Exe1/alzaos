      ...
      theme: {
        extend: {
          colors: {
            ...
            danger: '#ef4444',
            customAzul: '#8B0000	',
            customGreen: '#ff0000', // Adicionando a cor personalizada
          },
          fontFamily: {
    ...
    <div class="container mx-auto">
     ...
     style="background-image: url('<?php echo $bg_desktop ?>'); background-size: cover; background-position: center;">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4 mb-6">
          <?php if($botao1 != ""){ ?>
          <a href="#plans" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-lg text-white bg-customGreen hover:bg-red-700 focus:outline-none animate-pulse-orange transition-all duration-300">
            <i class="fas fa-rocket mr-2"></i> <?php echo $botao1 ?>
          </a>
        <?php } ?>
         <?php if($botao2 != ""){ ?>
          <a href="https://wa.me/5594996655467?text=Ol%C3%A1,%20Gostaria%20de%20fazer%20um%20teste%20Gr%C3%A1tis%20do%20seu%20Sistema" class="inline-flex items-center justify-center px-6 py-3 border border-white/20 text-base font-medium rounded-lg shadow-lg text-white hover:bg-white/10 focus:outline-none transition-all duration-300">
            <i class="fas fa-info-circle mr-2"></i> <?php echo $botao2 ?>
          </a>
           <?php } ?>
         <?php if($botao3 != ""){ ?>
           <a href="<?php echo $link_painel ?>" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-lg text-white bg-customAzul hover:bg-red-700 focus:outline-none animate-pulse-blue transition-all duration-300">
            ...
            <div class="bg-glass border border-gray-700 rounded-xl overflow-hidden h-full flex flex-col shadow-lg">
              <div class="p-6 text-center border-b border-gray-700">
                ...
                <div class="flex items-baseline justify-center">
                  ...
                  <span class="text-4xl font-bold price-text"><?php echo $valorF ?></span>
              ...
              <div class="p-6 text-center">
                <form action="assinar.php" method="POST" target="_blank">
                  ...
                  <button class="w-full bg-customGreen hover:bg-red-700 text-white font-semibold py-3 px-4 rounded-full transition-all duration-300 animate-pulse-green btn-subscribe" type="submit">
    ...
    <?php } ?>
      ...
      <?php if($botao_rodape != ""){ ?>
        <div class="flex justify-center">
          <a href="<?php echo $link_rodape ?>" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-lg text-white bg-customGreen hover:bg-red-700 focus:outline-none animate-pulse-green transition-all duration-300 transform hover:-translate-y-1">
